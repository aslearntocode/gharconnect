...
Let's turn everyday essentials into something extra special!`,
  ...
  },
  {
    ...
    name: 'Anjali Desai',
    category: 'education',
    description: 'Experienced mathematics tutor for CBSE and ICSE boards. Specializes in making complex concepts easy to understand.',
    ...
    skills: ['Mathematics', 'CBSE', 'ICSE', 'Algebra', 'Calculus', 'Problem Solving'],
    ...
    portfolio: ['https://youtube.com/@anjalimaths', 'https://linkedin.com/in/anjalidesai'],
    is_verified: true,
    is_active: true,
    rating: 4.7,
    review_count: 31,
