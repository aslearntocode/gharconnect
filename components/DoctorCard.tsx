    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 duration-300 h-full flex flex-col">
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
        ...
        {showPhoneNumber ? (
          ...
          <button onClick={() => setShowPhoneNumber(true)} className="inline-flex items-center px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors text-sm">
            <FiPhone className="w-4 h-4 mr-2" />
            Show Number
          </button>
        )}
