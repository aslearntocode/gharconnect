...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/parel/careers" className="hover:text-white/90">Careers</Link>
              </li>
              {/* <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/worli/" className="hover:text-white/90">Worli Community</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} GharConnect Platform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
