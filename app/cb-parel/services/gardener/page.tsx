...
import { gardenerServices } from '@/app/cb-parel/data/services/gardener';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative">
        <div className="w-full h-32 bg-blue-600 flex items-center justify-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white">Gardener Services</h1>
        </div>
        {/* Filter/Search Bar */}
