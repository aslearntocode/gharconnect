...
import { yogaServices } from '@/app/cb-parel/data/services/yoga';
import { VendorCard } from '@/components/VendorCard';

const vendors = Array.from(new Set(yogaServices.map(p => p.brand))).map(brand => ({
  name: brand,
  services: yogaServices.filter(p => p.brand === brand),
