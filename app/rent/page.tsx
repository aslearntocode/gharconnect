      ...
      <main className="pt-16 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/rent/t1" className="block group">
            ...
            <Link href="/rent/t2" className="block group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200 flex items-center gap-4">
                <FiHome className="text-4xl text-blue-600 flex-shrink-0" />
                <div>
            ...
            <Link href="/rent/t3" className="block group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200 flex items-center gap-4">
                <FiHome className="text-4xl text-blue-600 flex-shrink-0" />
                <div>
            ...
            <Link href="/rent/t4" className="block group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200 flex items-center gap-4">
                <FiHome className="text-4xl text-blue-600 flex-shrink-0" />
                <div>
            ...
            <Link href="/rent/t5" className="block group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200 flex items-center gap-4">
                <FiHome className="text-4xl text-blue-600 flex-shrink-0" />
                <div>
            ...
            <Link href="/rent/t6" className="block group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 group-hover:border-blue-200 flex items-center gap-4">
                <FiHome className="text-4xl text-blue-600 flex-shrink-0" />
                <div>
