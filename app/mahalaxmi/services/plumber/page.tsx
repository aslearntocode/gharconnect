...
import { vendors } from '@/app/mahalaxmi/data/services/plumber';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative">
        <div className="w-full h-32 bg-indigo-600 flex items-center justify-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white">Plumbing Services</h1>
        </div>
        {/* Filter/Search Bar */}
        ...
        <div className="max-w-7xl mx-auto">
          {filteredVendors.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No plumbing services found matching your search.</p>
            </div>
          ) : (
