...
export default function PostDetailPage() {
  ...
  const structuredData = post ? {
    ...
    "url": `https://gharconnect.in/mahalaxmi/connect/${post.id}`,
    "publisher": {
      "@type": "Organization",
      "name": "GharConnect",
  ...
  return (
    <>
      <Head>
        <title>{post ? `${post.title} - Mahalaxmi Community Discussion | GharConnect` : 'Community Discussion - Mahalaxmi | GharConnect'}</title>
        <meta name="description" content={post ? `Join the discussion about "${post.title}" in the Mahalaxmi community. Read comments, share your thoughts, and connect with neighbors in Mahalaxmi.` : 'Join community discussions in Mahalaxmi. Share thoughts, ask questions, and connect with neighbors.'} />
        <meta name="keywords" content="Mahalaxmi community discussion, neighborhood forum, local discussions Mahalaxmi, community posts, Mahalaxmi residents forum" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={post ? `${post.title} - Mahalaxmi Community Discussion | GharConnect` : 'Community Discussion - Mahalaxmi | GharConnect'} />
        <meta property="og:description" content={post ? `Join the discussion about "${post.title}" in the Mahalaxmi community. Read comments, share your thoughts, and connect with neighbors in Mahalaxmi.` : 'Join community discussions in Mahalaxmi. Share thoughts, ask questions, and connect with neighbors.'} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://gharconnect.in/mahalaxmi/connect/${postId}`} />
        <meta property="og:site_name" content="GharConnect" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={post ? `${post.title} - Mahalaxmi Community Discussion | GharConnect` : 'Community Discussion - Mahalaxmi | GharConnect'} />
        <meta name="twitter:description" content={post ? `Join the discussion about "${post.title}" in the Mahalaxmi community.` : 'Join community discussions in Mahalaxmi.'} />
        <link rel="canonical" href={`https://gharconnect.in/mahalaxmi/connect/${postId}`} />
        {structuredData && (
          <script
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto py-8 px-4">
          <nav aria-label="Breadcrumb">
            <Link href="/mahalaxmi/connect" className="text-blue-600 hover:underline mb-4 inline-block">&larr; Back to all posts</Link>
          </nav>
          {loading ? (
            <div>Loading...</div>
          ) : !post ? (
