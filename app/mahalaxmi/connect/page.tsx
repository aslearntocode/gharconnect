...
export default function MahalaxmiConnectPage() {
  ...
  const structuredData = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How can I connect with neighbors in Mahalaxmi?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Join our community discussion forum to share thoughts, ask questions, and get to know your neighbors in Mahalaxmi. You can post about local events, recommendations, or any community-related topics."
        }
      },
      {
        "@type": "Question",
        "name": "What topics can I discuss in the Mahalaxmi community forum?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can discuss local events, recommendations, community issues, neighborhood updates, local services, and any topics relevant to the Mahalaxmi community."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>Community Discussions & Connect with Neighbors in Mahalaxmi | GharConnect</title>
        <meta name="description" content="Join the Mahalaxmi community discussion forum. Share thoughts, ask questions, and connect with neighbors. Find local recommendations, events, and community updates in Mahalaxmi." />
        <meta name="keywords" content="Mahalaxmi community, neighborhood discussions, local events Mahalaxmi, community forum, connect with neighbors, Mahalaxmi residents, local recommendations" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Community Discussions & Connect with Neighbors in Mahalaxmi | GharConnect" />
        <meta property="og:description" content="Join the Mahalaxmi community discussion forum. Share thoughts, ask questions, and connect with neighbors. Find local recommendations, events, and community updates in Mahalaxmi." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://gharconnect.in/mahalaxmi/connect" />
        <meta property="og:site_name" content="GharConnect" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Community Discussions & Connect with Neighbors in Mahalaxmi | GharConnect" />
        <meta name="twitter:description" content="Join the Mahalaxmi community discussion forum. Share thoughts, ask questions, and connect with neighbors." />
        <link rel="canonical" href="https://gharconnect.in/mahalaxmi/connect" />
        <script
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="w-full bg-indigo-600 py-1 md:py-4 flex flex-col items-center justify-center text-center mb-4">
          <h1 className="text-xl md:text-3xl font-bold text-white mb-1">👋 Welcome to Mahalaxmi's Own Social Network</h1>
        ...
        <div className="max-w-7xl mx-auto py-8 px-2 lg:px-4 flex flex-col lg:flex-row gap-4 lg:gap-6">
          ...
          <div className="flex-1">
            ...
            <section className="sr-only mb-8 bg-white p-6 rounded-lg shadow-sm">
              {/* <h2 className="text-xl font-semibold text-gray-900 mb-3">Welcome to Mahalaxmi Community Discussions</h2> */}
              <div className="sr-only">
                <p className="text-gray-700 mb-4">
                  ...
                  this is the perfect place to engage with the Mahalaxmi community.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="bg-indigo-50 p-3 rounded">
                    <h3 className="font-semibold text-indigo-800 mb-1">Local Recommendations</h3>
                    <p className="text-indigo-700">Share and discover the best local restaurants, services, and hidden gems in Mahalaxmi.</p>
                  </div>
                  <div className="bg-green-50 p-3 rounded">
                    <h3 className="font-semibold text-green-800 mb-1">Community Events</h3>
                    <p className="text-green-700">Stay updated on local events, festivals, and community gatherings in Mahalaxmi.</p>
                  </div>
                  ...
                  {filteredPosts.map(post => (
                    <li key={post.id} className="bg-white rounded-xl shadow border border-gray-100 p-5 flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-2 text-xs md:text-sm text-gray-500 mb-1">
                        ...
                        <span className="font-semibold text-gray-800">gc/Mahalaxmi</span>
                      ...
                      <div className="flex gap-3 mt-2">
                        ...
                        <Link href={`/mahalaxmi/connect/${post.id}`} className="flex items-center gap-1 px-3 md:px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-xs md:text-sm">
                          {/* Speech bubble icon */}
