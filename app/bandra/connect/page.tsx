...
export default function BandraConnectPage() {
  ...
  const fetchTopUsers = async () => {
    ...
    // Get posts count by user for Bandra area
    const { data: postsData, error: postsError } = await supabase
      .from('posts')
      .select('user_id')
      .eq('area', 'Bandra');
    
    // Get comments count by user for Bandra posts
  ...
  const structuredData = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How can I connect with neighbors in Bandra?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Join our community discussion forum to share thoughts, ask questions, and get to know your neighbors in Bandra. You can post about local events, recommendations, or any community-related topics."
        }
      },
      {
        "@type": "Question",
        "name": "What topics can I discuss in the Bandra community forum?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can discuss local events, recommendations, community issues, neighborhood updates, local services, and any topics relevant to the Bandra community."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Head>
        <title>Community Discussions & Connect with Neighbors in Bandra | GharConnect</title>
        <meta name="description" content="Join the Bandra community discussion forum. Share thoughts, ask questions, and connect with neighbors. Find local recommendations, events, and community updates in Bandra." />
        <meta name="keywords" content="Bandra community, neighborhood discussions, local events Bandra, community forum, connect with neighbors, Bandra residents, local recommendations" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Community Discussions & Connect with Neighbors in Bandra | GharConnect" />
        <meta property="og:description" content="Join the Bandra community discussion forum. Share thoughts, ask questions, and connect with neighbors. Find local recommendations, events, and community updates in Bandra." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://gharconnect.in/bandra/connect" />
        <meta property="og:site_name" content="GharConnect" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Community Discussions & Connect with Neighbors in Bandra | GharConnect" />
        <meta name="twitter:description" content="Join the Bandra community discussion forum. Share thoughts, ask questions, and connect with neighbors." />
        <link rel="canonical" href="https://gharconnect.in/bandra/connect" />
        <script
              ...
              <ul className="space-y-3">
                {topLikedPosts.map(post => (
                  <li key={post.id} className="flex items-center justify-between">
                    <Link href={`/bandra/connect/${post.id}`} className="text-blue-700 font-medium hover:underline line-clamp-1 flex-1">{post.title}</Link>
