...
export default function MarketplacePage() {
  ...
  const handleWhatsAppChat = (phone: string, title: string) => {
    ...
    const message = `Hi! I'm interested in your item "${title}" from the Parel marketplace. Can you tell me more about it?`
  ...
  const handleSellItem = () => {
    ...
    router.push('/parel/marketplace/sell')
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full h-32 bg-indigo-600 flex items-center justify-center">
        <h1 className="text-3xl md:text-4xl font-bold text-white">Parel Marketplace</h1>
      </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                {selectedCategories.length > 0 || selectedConditions.length > 0 || selectedPriceRanges.length > 0
                  ...
                  : 'Be the first to list an item in Parel marketplace!'
                }
              </p>
            </div>
          ) : (
