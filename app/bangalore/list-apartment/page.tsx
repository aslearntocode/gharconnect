...
export default function RentApartmentPage() {
  ...
  const onSubmit = async (data: ApartmentFormData) => {
    ...
    try {
      ...
      const result = await createApartment(data, user.id, location);
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col gap-4 px-2 sm:px-4">
        ...
        >
          ...
          <div className="md:w-2/3 text-left">
            ...
            <p className="text-gray-700 text-sm md:text-lg leading-relaxed">We market your property to our community of tenants who are looking for a new home. We are present at various events that are organized in your areas.</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="md:w-2/3 text-left">
            ...
            <p className="text-gray-700 text-sm md:text-lg leading-relaxed">Our property management services include move-in/move-out audits, quarterly inspections, maintenance support, and a designated property manager. We provide these services to help owners manage their properties more effectively.</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="md:w-2/3 text-left">
            ...
            <p className="text-gray-700 text-sm md:text-lg leading-relaxed">The rental process involves a lot of paperwork, including rental agreements, security deposits, and utility bills. We handle all the paperwork for you, ensuring that it is completed accurately and in a timely manner.</p>
          </div>
        </motion.div>
      </div>
    </section>
  ...
  const FloatingLoginBox = (
    <div className="sticky top-4 bg-white rounded-lg shadow-xl p-8 max-w-md w-full h-fit">
      ...
      <a
        href="https://wa.me/919321314553?text=I'm%20interested%20in%20listing%20my%20property%20for%20rent%20in%20Bangalore"
        target="_blank"
