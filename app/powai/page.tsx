...
export default function PowaiPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-100 px-4">
      <div className="max-w-2xl text-center">
        <h1 className="text-4xl font-extrabold text-purple-700 mb-6">
          Powai Communities Coming Soon!
        </h1>
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <p className="text-gray-600 text-lg mb-4">
            We're currently onboarding communities in Powai, Chandivali, and surrounding areas.
          </p>
