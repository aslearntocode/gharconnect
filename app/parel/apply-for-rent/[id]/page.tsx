  ...
  if (submissionSuccess) {
    return (
      <ConfirmationPage
        ...
        buttonText="Back to Parel Rentals"
        buttonLink="/parel/rent"
      />
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-2xl py-6 px-4">
        <p className="text-gray-600 mb-6">Submit your details to schedule a visit for the property at <span className="font-semibold">{apartment?.building_name}</span>.
