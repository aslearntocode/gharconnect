...
export default function RentApartmentPage() {
  ...
  const onSubmit = async (data: ApartmentFormData) => {
    ...
    try {
      ...
      const result = await createApartment(data, user.uid, 'Parel');
    ...
    <div className="bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-lg bg-indigo-100 border border-indigo-300 px-4 py-3 text-indigo-800 font-semibold text-center text-base">
          This listing will be visible under <span className="font-bold">Parel</span>.
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1">Fill in the details below to create your rental listing in Parel</p>
              </div>
            </div>
          </div>
