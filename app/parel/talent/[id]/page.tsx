      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="pt-20 pb-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/parel/talent" className="text-purple-600 hover:text-purple-700">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href="/parel/talent" className="inline-flex items-center gap-2 text-purple-600 hover:text-purple-700 mb-6">
