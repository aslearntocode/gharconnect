                  ...
                  {filteredPosts.map(post => (
                    <li key={post.id} className="bg-white rounded-xl shadow border border-gray-100 p-5 flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-500 mb-1">
                        ...
                        <span className="font-semibold text-gray-800">r/Parel</span>
                      ...
                      <div className="flex gap-3 mt-2">
                        ...
                        <Link href={`/parel/connect/${post.id}`} className="flex items-center gap-1 px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold">
                          {/* Speech bubble icon */}
