...
export default function ThanePage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-white to-teal-100 px-4">
      <div className="max-w-2xl text-center">
        <h1 className="text-4xl font-extrabold text-teal-700 mb-6">
          Thane Communities Coming Soon!
        </h1>
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <p className="text-gray-600 text-lg mb-4">
            We're currently onboarding communities in Thane, Ghodbunder Road, and surrounding areas.
          </p>
          <p className="text-gray-600 text-lg mb-6">
            Stay tuned as we bring the power of community connection to your neighborhood!
          </p>
          <div className="inline-flex items-center px-4 py-2 bg-teal-100 text-teal-700 rounded-lg">
