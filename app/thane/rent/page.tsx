          ...
          <table className="min-w-full divide-y divide-gray-200 md:table hidden">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Rent<br/><span className="text-xs font-normal normal-case">negotiable with <>  </>varied payment terms</span></th>
