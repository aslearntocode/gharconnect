...
import { vendors } from '@/app/mumbai/community/data/services/scrap-dealer';
import { VendorCard } from '@/components/VendorCard';
import { FiSearch } from 'react-icons/fi';
import { searchVendors } from '@/utils/searchUtils';
import Disclaimer from '@/components/Disclaimer';

export default function ScrapDealerPage() {
    ...
    <div className="min-h-screen bg-gray-50 ">
      ...
      <div className="relative mt-12 md:mt-16">
        <div className="w-full h-32 bg-indigo-600 flex items-center justify-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white">Scrap Dealers (Raddiwala)</h1>
        </div>
        {/* Filter/Search Bar */}
        <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-7 w-full max-w-2xl z-10">
          <div className="bg-white rounded-2xl shadow-lg flex items-center px-4 py-3 gap-2">
            ...
            <input
              type="text"
              placeholder="Search for scrap dealers..."
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {filteredVendors.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No scrap dealers found matching your search.</p>
            </div>
          ) : (
