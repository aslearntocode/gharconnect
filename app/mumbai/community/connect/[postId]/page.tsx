      ...
      <main className="min-h-screen bg-gray-50 lg:pt-16">
        ...
        <div className="max-w-2xl mx-auto py-8 px-4">
          <nav aria-label="Breadcrumb">
            <Link href="/mumbai/community/connect" className="text-blue-600 hover:underline mb-4 inline-block">&larr; Back to all posts</Link>
          </nav>
          {loading ? (
            <div>Loading...</div>
          ) : !post ? (
              ...
              <article className="bg-white p-4 rounded shadow mb-6">
                <header>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="font-semibold text-sm text-gray-600">{post.category || 'gc/parel'}</span>
                  </div>
