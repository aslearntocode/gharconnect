export default function MumbaiSharedPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Blue Banner */}
      <div className="relative">
        <div className="w-full bg-indigo-600 flex flex-col items-center justify-center py-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white text-center">Shared Accommodation in Mumbai</h1>
          <p className="text-indigo-100 text-base md:text-lg mt-2 text-center max-w-5xl">
            Find shared flats and rooms for rent in Mumbai.
          </p>
        </div>
      </div>
      ...
      {/* <div className="max-w-6xl mx-auto w-full flex justify-start mt-4 mb-2 px-4">
        <a href="/mumbai" className="inline-flex items-center px-3 py-1.5 bg-white border border-indigo-600 text-indigo-700 font-semibold rounded-lg shadow hover:bg-indigo-50 transition-all text-sm">
        ...
        <div className="text-center max-w-2xl">
          <div className="mb-6">
            ...
            <p className="text-xl text-gray-600 mb-6">
              We're working hard to bring you the best shared accommodation options in Mumbai.
            </p>
