...
export default function SocietiesClient() {
  ...
  return (
    <>
      ...
      {/* thedivinehands.com Banner - now after societies */}
      <section aria-label="Sponsored Advertisement" className="relative w-full bg-gradient-to-r from-indigo-600 via-indigo-500 to-indigo-600 text-white overflow-hidden">
