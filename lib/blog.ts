...
`,
  ...
  },
  {
    ...
    content: `In every housing society, residents rely on a range of service providers — electricians, maids, plumbers, painters, movers, pest control, internet installers, and more. While some vendors provide excellent service, others may be unreliable, overpriced, or unprofessional.
...
Ashok Towers offers the rare combination of open space and premium living in Mumbai. With tennis courts, multiple swimming pools, large green areas, and high-rise views, it appeals to both families and professionals. It's also conveniently located near business hubs like Lower Parel.
